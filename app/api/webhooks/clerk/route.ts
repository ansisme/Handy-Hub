...
if(eventType === 'user.created'){
    ...
    if(newUser){
        ...
        //just like we made the clerk connection in the database connection by defining the clerkId in the user model
...
//whenever a user is updated, event occured
if (eventType === 'user.updated') {
    ...
    //whenever a user is deleted, event occured
