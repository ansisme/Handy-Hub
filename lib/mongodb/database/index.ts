...
let cached = (global as any).mongoose || { conn: null}; //in case we dont have a mongoose connection we simply set the connection to a null promise

export const connectToDatabase = async () => {
    if(cached.conn) return cached.conn; //if a cached connection exists we exist out of function and return it
...
// everytime we execute serveractions
